    ...
    def __init__(self, args, debias_model=None, model=None):
        ...
        if self.args.use_weight:
            if self.args.debias_mode in ['Propensity_Mode', 'SNIPS_Mode']:
                ...
                ut.load_model_by_name('Pretrain+'+self.args.dataset, self.acl_discriminito_o, 0)
...
#         print('xuxuuxuxu', len(user_dic.keys()))
    ...
    def pretrain(self, x, a, y, savestep=0, mode='propensity', save_flag=True, r=None):
...
#             print(x.size())
        ...
        if mode == 'discriminitor':
            return self.acl_discriminito_o.loss(x, a, r)
            '''
